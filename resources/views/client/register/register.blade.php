            ...
            <div class="col-sm-12 card-body">
                ...
                <form action="{{route('registration-process')}}" method="post">
                    ...
                    <div class="form-group row align-items-center">
                        <div class="col mt-4">
                            <input required ref="" name="full_name" type="text" class="form-control" placeholder="Full Name">
                    ...
                    <div class="form-group row align-items-center mt-4">
                        <div class="col">
                            <input required type="text" name="contact_no" class="form-control" placeholder="Contact No">

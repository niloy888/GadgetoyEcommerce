        ...
        <nav id="navbar-head-top" class="navbar navbar-expand-lg navbar-light">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar navbar-nav ml-auto">
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                            @foreach($brands as $brand)
                                <a class="dropdown-item"
                                   href="{{ route('brand-products',['id'=>$brand->id]) }}">{{$brand->brand_name}}</a>
                            @endforeach
                        </div>
                    </li>

                    {{--<li class="nav-item">
                        <a class="nav-link" href="{{route('vendor-register')}}">Sell on Gadgetoy</a>
                    </li>--}}
                    ...
                    <li class="nav-item">
                        <a href="{{route('show-cart')}}"><span class="ion-android-cart"> {{Cart::count()}} products</span> </a>
                    </li>

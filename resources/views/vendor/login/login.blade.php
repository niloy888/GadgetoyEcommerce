...
<div class="global-container">
    <div class="card login-form">
        <div class="card-body">
            <h3 class="card-title text-center">Log in (Seller)</h3>
            <div class="card-text">
                <!--
                <div class="alert alert-danger alert-dismissible fade show" role="alert">Incorrect username or password.</div> -->
                <form action="{{route('vendor-new-login')}}" method="post">
                    @csrf
                    ...
                    <div class="sign-up">
                        Don't have an account? <a href="{{route('vendor-register')}}">Create One</a>
                    </div>
                </form>
            </div>
        </div>

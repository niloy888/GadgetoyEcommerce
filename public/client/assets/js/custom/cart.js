    ...
    isCartExist(function(data){
        if(data.total <= 0)
        {
            ...
            $.ajax({
				...
				//dataType: 'json',
				url: "./confim-order",
				data: {name: name, lastname:lastname,status:status,credit:credit,debit:debit,paypal:paypal,expireDate:expireDate,security_number:security_number,comment:comment,email:email,address:address,cardname:cardname,cardno:cardno},
